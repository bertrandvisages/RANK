/*
  ...
  1. Security
    ...
    - Create new policies for:
      - Insert: Allow authenticated users to create profiles with their user ID
  ...
  Note: This migration ensures proper profile creation during signup
*/
...
-- Create fresh policies with proper insert handling
